...
from distance_metrics import normalized_graph_edit_distance, create_distance_matrix
...
def main(args):
    ...
    distance_matrix = create_distance_matrix(local_patterns, normalized_graph_edit_distance,
